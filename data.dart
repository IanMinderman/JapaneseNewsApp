...
List<CategorieModel> getCategories(){
  ...
  categorieModel.categorieName = "ビジネス";
  ...
  //2
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "娯楽";
  ...
  //3
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "一般的な";
  ...
  //4
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "健康";
  ...
  //5
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "理科";
  ...
  //5
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "スポーツ";
  ...
  //5
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "技術 ";
